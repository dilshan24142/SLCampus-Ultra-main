...
public partial class Admin_ManageProducts : System.Web.UI.Page
{
    ...
    protected void gvproduct_RowUpdating(object sender, GridViewUpdateEventArgs e)
    {
        ...
        if (Path.GetExtension(fup.PostedFile.FileName) == ".jpg" || Path.GetExtension(fup.PostedFile.FileName) == ".jpeg" || Path.GetExtension(fup.PostedFile.FileName) == ".bmp" || Path.GetExtension(fup.PostedFile.FileName) == ".png" || Path.GetExtension(fup.PostedFile.FileName) == ".jfif")
        {
