...
public partial class Registration : System.Web.UI.Page
{
    ...
    private void SendMail()
    {
        ...
        Msg.From = new MailAddress("sakunibulegoda@gmail.com");
        // Recipient e-mail address.
        Msg.To.Add(txtemail.Text);
        Msg.Subject = "Confirmation";
        string body = "Successfully registered with SlC Ultra";
        Msg.Body = body;
        Msg.IsBodyHtml = true;
        ...
        smtp.Port = 587;
        smtp.Credentials = new System.Net.NetworkCredential("sakunibulegoda@gmail.com", "dulara@2001896");
        smtp.EnableSsl = true;
        smtp.Send(Msg);
    }
