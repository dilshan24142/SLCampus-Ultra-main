<%@ Page Language="C#" AutoEventWireup="true" CodeFile="nsbm2.aspx.cs" Inherits="SliitCourses" MasterPageFile="~/GrocerySite.master" %>
...
.course {
    ...
    <asp:HyperLink ID="hyperlinkNextPage" runat="server" NavigateUrl="~/nsbm1.aspx" CssCass="next-page-link">Go to Back</asp:HyperLink>
    <p>Select from a variety of courses offered at Campus.</p>
    
    <div class="course-category">
        <div class="marquee">
        <h1>Engineering &amp; Tec</h1>
            </div>
