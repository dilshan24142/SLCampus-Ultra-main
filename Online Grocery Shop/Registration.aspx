<%@ Page Title="" Language="C#" MasterPageFile="~/GrocerySite1.master" AutoEventWireup="true" CodeFile="Registration.aspx.cs" Inherits="Registration" %>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              <asp:ListItem Value="Sri Lankan" Text="Sri Lankan" />
