<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/GSADMIN.master" AutoEventWireup="true" CodeFile="ManageProducts - Copy.aspx.cs" Inherits="Admin_ManageProducts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <fieldset class="fieldsetmain">
        <legend>Gazatte & Job MANAGEMENT</legend>
        <!-- Add Post Section -->
        <div class="new-post">
            <h2>Add Your Post</h2>
